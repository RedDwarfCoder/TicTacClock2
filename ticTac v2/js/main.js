...
function startTime() {
	...
	if (hour >= 13) {
		$('.one').css('border-top', '3px solid #ff0000');
	}

	if (hour >= 14) {
		$('.two').css('border-top', '3px solid #ff0000');
	}

	if (hour >= 15) {
		$('.three').css('border-top', '3px solid #ff0000');
	}

	if (hour >= 16) {
		$('.three').css('border-right', '3px solid #ff0000');
	}

	if (hour >= 17) {
		$('.six').css('border-right', '3px solid #ff0000');
	}

	if (hour >= 18) {
		$('.nine').css('border-right', '3px solid #ff0000');
	}

	if (hour >= 19) {
		$('.nine').css('border-bottom', '3px solid #ff0000');
	}

	if (hour >= 20) {
		$('.eight').css('border-bottom', '3px solid #ff0000');
	}

	if (hour >= 21) {
		$('.seven').css('border-bottom', '3px solid #ff0000');
	}

	if (hour >= 22) {
		$('.seven').css('border-left', '3px solid #ff0000');
	}

	if (hour >= 23) {
		$('.four').css('border-left', '3px solid #ff0000');
	}

	if (hour >= 24) {
		$('.one').css('border-left', '3px solid #ff0000');
	}
	...
	for (var i = 0; i <= numberInlastGroup2; i++) {
		switch (i) {
			case 5:
			case 1:
				lastGroupText = lastGroupText + '|';
